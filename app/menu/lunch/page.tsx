...
export const metadata: Metadata = {
  title: "Lunch Menu | Kirwan's Irish Pub & Restaurant",
  description: "Kirwan's lunch menu — starters, salads, sandwiches, and traditional Irish fare. Available daily.",
};
  ...
  return (
    <section className="bg-[#050608] text-white py-16 px-4 md:px-8 lg:px-16">
      ...
      <div className="text-center">
        ...
        <p className="text-sm md:text-base text-white/60 mt-2">Available daily</p>
        {/* hours slot — populate when ready */}
        {/* <p className="text-xs text-gold/70 mt-1">Mon–Fri 11:30am – 3:00pm</p> */}
      </div>

      {/* Starters / Salads / Sandwiches grid */}
